...
| Hub API | none (tunnel only) | Noktah Hub backend, see [service/api/README.md](service/api/README.md) |
...
- [Noktah Hub web](service/web/README.md) and [API](service/api/README.md) - the managers' dashboard
